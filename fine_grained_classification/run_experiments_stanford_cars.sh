#!/bin/bash
# Stanford Cars 自动化实验脚本 - 与 run_experiments.sh 结构一致
...
# 用法: bash run_experiments_stanford_cars.sh [device] [batch_size] [epochs_list] [backbone_list]
# 示例: bash run_experiments_stanford_cars.sh cuda 16 "100,80,60,40,20" "RN50"
...
echo "=============================================="
echo "  Stanford Cars Fine-Grained Classification"
echo "=============================================="
echo "  Device:       $DEVICE"
...
CURRENT=0
FAILED=0
RESULTS_LOG="$SCRIPT_DIR/experiment_results_stanford_cars.log"
echo "Experiment Results (Stanford Cars) - $(date)" > "$RESULTS_LOG"
echo "==========================================" >> "$RESULTS_LOG"
...
echo ""
echo "=============================================="
echo "  All Stanford Cars experiments finished!"
echo "  Total: $TOTAL | Failed: $FAILED"
echo "  Results log: $RESULTS_LOG"
echo "=============================================="
echo ""
echo "Run 'python collect_results.py --base-dir output_fgd/stanford_cars' to generate comparison tables."
