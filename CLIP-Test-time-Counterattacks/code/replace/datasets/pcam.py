...
from torchvision.datasets.utils import download_file_from_google_drive, _decompress, verify_str_arg
...
class PCAM(VisionDataset):
    ...
    clip_prompts = [
        "This is a photo of a healthy lymph node tissue.",
        "This is a photo of a lymph node tumor tissue."
    ]
